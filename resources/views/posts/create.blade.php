                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="5" placeholder="Masukan Konten Post">{{ old('content') }}</textarea>
...
<script src="https://stackpath.bootsrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
